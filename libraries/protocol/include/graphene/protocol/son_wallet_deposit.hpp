...
FC_REFLECT(graphene::protocol::son_wallet_deposit_create_operation::fee_parameters_type, (fee) )
FC_REFLECT(graphene::protocol::son_wallet_deposit_create_operation, (fee)(payer)
...
FC_REFLECT(graphene::protocol::son_wallet_deposit_process_operation::fee_parameters_type, (fee) )
FC_REFLECT(graphene::protocol::son_wallet_deposit_process_operation, (fee)(payer)
